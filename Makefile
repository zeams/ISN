jeu : balle.o balle.h main.o pi.o main.h pi.h affichage.o affichage.h jeu.o jeu.h evenement.o evenement.h objet.o objet.h
	gcc -g -o3 balle.o balle.h evenement.h evenement.o jeu.o jeu.h constante.h affichage.o affichage.h main.o pi.o pi.h main.h objet.o objet.h -o jeu `sdl-config --libs --cflags` -Wall -Wextra -Werror 
	rm *.o

objet.o : objet.c objet.c constante.h
	gcc -c -g objet.c -o objet.h -Wall -Wextra -Werror

balle.o : balle.h constante.h balle.c
